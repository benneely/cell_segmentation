...
def get_anchors(
    ...
    backbone_shapes = compute_backbone_shapes(backbone_strides, image_shape)
...
class ProposalLayer(KE.Layer):
    ...
    def __init__(self, proposal_count, nms_threshold, images_per_gpu, rpn_bbox_std_dev, **kwargs):
